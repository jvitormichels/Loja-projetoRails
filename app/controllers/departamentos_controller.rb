class DepartamentosController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @departamento.update(departamento_params)
        format.html { redirect_to @departamento, notice: "Departamento editado com sucesso." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to departamentos_url, notice: "Departamento removudo com sucesso." }
